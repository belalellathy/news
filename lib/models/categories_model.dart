class CategoriesModel {
  ...
  String image;
  String name;
  CategoriesModel({required this.name, required this.id, required this.image});
  ...
  static List<CategoriesModel> categoriesDark = [
    ...
    CategoriesModel(
      id: 'business',
      image: 'assets/images/busniess_dark.png',
      name: 'Business',
    ),
    CategoriesModel(
      id: 'entertainment',
    ...
    CategoriesModel(
      id: 'sports',
      image: 'assets/images/sports_dark.png',
      name: 'Sports',
    ),
    CategoriesModel(
      id: 'technology',
      image: 'assets/images/tech_dark.png',
      name: 'Technology',
    ),
  ];
}
